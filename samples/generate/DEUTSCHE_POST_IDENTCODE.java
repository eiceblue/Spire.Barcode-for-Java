...
public class DEUTSCHE_POST_IDENTCODE {
    public static void main(String[] args) throws IOException {
        ...
        //Set Data
        settings.setData("56400000005");
        //Set the Symbology property
        settings.setType(BarCodeType.DEUTSCHE_POST_IDENTCODE);
        ...
        //Save the image
        ImageIO.write(bufferedImage,"png",new File("DEUTSCHE_POST_IDENTCODE.png"));
